export const languageLabels = {
  ...
  homeSectionsPosition: "Homepage Section Position",
  homeSectionsPositionNote: "(Negative (-) values move the element in the opposite direction.)",
  homeSectionsTop: "Vertical Align (vh)",
  sliderPosition: "Slider Position",
  slideTop: "Top Offset (%)",
  slideLeft: "Left Offset (%)",
