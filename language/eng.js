export const languageLabels = {
  ...
  enableDotPosterAnimations: "Enable Dot Navigation Poster Animations",
  ...
  slideAnimationDescription: "Animation effect used during transitions between slides",
  dotAnimationDescription: "Animation effect for posters in dot navigation",
  season: "Season",
  episode: "Episode",
  dakika: "minutes",
  kaldi: "left",
  maxShufflingLimit: "Maximum Shuffle Content Limit:",
  playingLimit: "Continue Watching Limit",
  maxShufflingLimitDesc: "The content limit used to create the slider. For example, if you set it to 1000, the slider will be created by selecting from 1000 contents.",
  playingLimitDesc: "Lists the most recently interrupted contents. A value of '0' disables it.",
  limitDesc: "Slider item limit visible on screen",
  excludeEpisodesFromPlaying: "Exclude TV Show Episodes",
  excludeEpisodesFromPlayingDesc: "If checked, excludes TV show episodes from the 'Continue Watching' list",
  showPlaybackProgress: "Show Progress Bar",
  ...
  showMetadata: "Enable Metadata Information",
  ...
  pauseOverlayDescription: "When this feature is enabled, a screen displaying content information appears when the video is paused.",
  indexZeroSelection: "Always select default image",
  indexZeroDescription: "When active, always selects index 0 image and does not choose among backdrops.",
