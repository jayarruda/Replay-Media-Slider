export const languageLabels = {
  ...
  cssDescription: "• A visualização em tela cheia é ajustada para `Poster Dot` em ambientes de desktop.",
  cssMobileNote: "• A visualização da vitrine ainda não está pronta para dispositivos móveis.",
  peakSpanRight: "Contagem de cartões do lado direito:",
  peakSpanLeft: "Contagem de cartões do lado esquerdo:",
  peakGapLeft: "Eixo X do lado esquedo (px)",
  peakGapRight: "Eixo X do lado direito (px)",
  peakGapY: "Eixo Y direito e esquerdo (px)",
  peakslider: "Visualização da vitrine (Beta)",
  requireWebSocket: "Use apenas WebSocket para capturar vídeo",
  pauseOverlayDescription: "Usar apenas o WebSocket fornece resultados mais precisos, mas às vezes a conexão pode falhar. Quando desmarcado, métodos alternativos são tentados junto com o WebSocket.",
  pauseOverlayMinVideoMinutesDesc: "Para vídeos com duração inferior a este valor (mínimo), o emblema e a tela de pausa não serão exibidos.",
  pauseOverlayMinVideoMinutes: "Duração mínima do vídeo (emblema/sobreposição)",
  genel: "Geral",
  fetchLyricsRunning: "As letras já estão sendo atualizadas...",
  starting: "Iniciando...",
  cancelling:"Cancelando...",
  fetchLyricsCancelled: "Operação cancelada",
  saved: "salvo",
  processing: "Processando",
  hubsUnderStudioHubs: "Coloque no topo",
  ...
  lyricsAdminOnly: "Somente administradores",
  lyricsType: "Tipo de download",
  lyricsSynced: "Sincronizado (.lrc)",
  lyricsPlain: "Simples",
  lyricsPreferSynced: "Prefira sincronizado, caso contrário, simples",
  lyricsPreferPlain: "Prefira simples, caso contrário, sincronizado",
  lyricsOverwrite: "Se o arquivo existir",
  lyricsOverwriteSkip: "Ignorar (recomendado)",
  lyricsOverwriteReplace: "Substituir",
  lyricsResumeHint: "Um trabalho está em andamento, modal aberto.",
  lyricsSummaryTitle: "Resumo da letra",
  lyricsSummaryOk: "Bem-sucedido",
  lyricsSummarySynced: "Sincronizado",
  lyricsSummaryPlain: "Simples",
  lyricsSummaryFail: "Falha",
  lyricsSyncNote: "<strong>Nota:</strong> Não se esqueça de sincronizar as letras!",
  adim: "Executado",
  ...
  noLogToCopy: "Nenhum registro para copiar",
  logInfo: "[INFO]",
  logWarn: "[WARNING]",
  logError: "[ERROR]",
  logOk: "[OK]",
  ...
  shRequiresBash: "Este script requer o bash. Execute com 'bash trailers.sh'.",
  ...
  shSetApiKeys: "JF_API_KEY e TMDB_API_KEY devem ser definidos.",
  shInvalidOverwrite: "OVERWRITE_POLICY inválido (ignorar|substituir|se melhor).",
  shUserNotFound: "Usuário não encontrado.",
  shProcessing: "Processando: {name} (IMDb: {imdb}, TMDb: {tmdb}, Type: {type})",
  ...
  shIfBetterMode: "Modo if-better: fará o download para comparação.",
  shTmdbMissing: "Sem ID TMDb.",
  shSeriesTmdbMissing: "Sem série TMDb ID.",
  shUnsupportedType: "Tipo não suportado.",
  shNoPath: "Sem caminho.",
  ...
  shNoDownloadableFound: "Não foi encontrado nenhum trailer adequado para download.",
  shRefreshFailed: "Erro ao atualizar.",
  shCleaningTemps: "Limpeza de arquivos temporários...",
  shFinishedCount: "Concluído: processado={n}",
  shSummaryLine: "RESUMO -> baixado={ok}, com falha={fail}, ignorado={skip}",
  rxFinishedProcessed: "CONCLUÍDO:\\s*processed\\s*=\\s*(\\d+)",
  rxSummaryOkFail: "RESUMO\\s*->\\s*downloaded\\s*=\\s*(\\d+)\\s*,\\s*failed\\s*=\\s*(\\d+)",
