export const languageLabels = {
  ...
  smartAutoPauseDescription: "Automatically pauses the video based on user activity, window focus/tab state, and content visibility. Optionally includes Idle Detection and PiP respect.",
  smartIdleThresholdMs: "Pause if Idle (min)",
  smartUnfocusedThresholdMs: "Pause if Window Not Focused (min)",
  smartOffscreenThresholdMs: "Pause if Video Not Visible (min)",
  smartUseIdleDetection: "Use Idle Detection API (if supported)",
  smartRespectPiP: "Pause when PiP is active",
  ...
  cssDescription: "Designed for the Activated Poster Dot in Fullscreen Desktop Environments.",
