export const languageLabels = {
  ...
  preferTrailersInPreviewModal: "Show Trailer > Video in Modal",
  onlyTrailerInPreviewModal: "Show Only Trailer in Modal",
  ...
  paused: "Paused",
  previewModal: "Enable Preview Modal",
  allPreviewModal: "Apply Modal to All of Jellyfin",
  enableHlsDescription: "When HLS is enabled, transcoding is performed for videos played in the Preview Modal. Using ffmpeg may result in high CPU usage. If not enabled, only video and audio codecs supported by the browser will be played.",
